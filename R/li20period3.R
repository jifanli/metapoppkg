#' Covid spatPomp generator for Jan 10 - Feb 8
#'
...
li20period3 <- function(li20_version = "v5", U = 373, dt = 1/4,
  ...
  if (li20_version == "v5"){
    li20v5(U = U, dt = dt,
           ...
           version = version, mob_modify_factor=mob_modify_factor, days = 30, for_ibpf = for_ibpf)
    ...
    li20(U = U, dt = dt, 
         ...
         mob_modify_factor=mob_modify_factor, days = 30)
  }
}
