...
#'
#' Visualize li20 or li23 COVID-19 data, with Wuhan in red.
#' Used to generate figures for the manuscrip and supplement of Li et al (2023).
#'
#' @param U number of the cities
#' @param x a \code{spatPomp} object generated by li20(), li23(), li23v2(), etc 
#' @param limit the upper limit of case numbers in the plot, on a log10 scale
